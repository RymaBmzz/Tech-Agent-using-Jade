...
public class VendeurContainer {
	...
	public static void main(String[] args) {
		...
		//	AgentContainer agentC= runtime.createAgentContainer(profiles);
		    AgentController agController = agentC.createNewAgent("Vendeur", AgVendeur.class.getName(),new Object[]{});//argument new Object[]{}
		    agController.start();
